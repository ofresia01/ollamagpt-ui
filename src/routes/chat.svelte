...
<div class="h-[75vh] max-w-4xl mx-auto p-6 bg-gray-900 opacity-85 flex flex-col rounded-4xl">
    <h1 class="antialiased mb-8 font-sans font-semibold tracking-tight text-4xl text-center text-sky-500">OllamaGPT</h1>
    <div class="flex-1 overflow-y-auto p-4">
        {#each chatHistory as chat}
            <div class="container">
                <div class="flex justify-end">
                    <div class="bg-blue-700 text-white p-3 rounded-lg max-w-[70%] mx-2 my-4">
                        <p>{chat.user}</p>
                    </div>
                </div>
                <div class="flex justify-start">
                    <div class="bg-gray-700 text-white p-3 rounded-lg max-w-[70%] mx-2 my-2">
                        <p>{chat.bot}</p>
                    </div>
                </div>
            </div>
