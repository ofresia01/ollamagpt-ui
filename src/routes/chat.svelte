...
<div class="h-[75vh] max-w-4xl mx-auto p-6 bg-gray-900 opacity-85 flex flex-col">
        ...
        {#each chatHistory as chat}
            <div class="container"> <!-- Adjusted spacing -->
                <div class="flex justify-end">
                    <div class="bg-blue-700 text-white p-3 rounded-lg max-w-[70%] mx-2 my-4"> <!-- Added bottom margin -->
                        <p>{chat.user}</p>
                    </div>
                </div>
                <div class="flex justify-start">
                    <div class="bg-gray-700 text-white p-3 rounded-lg max-w-[70%] mx-2 my-2"> <!-- Added bottom margin -->
                        <p>{chat.bot}</p>
                    </div>
                </div>
            </div>
